...
export default function EditTeamMemberPage() {
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6"><Link href="/admin/team-members" className="text-text-secondary hover:text-primary"><ArrowLeft className="w-5 h-5" /></Link><h1 className="text-2xl font-heading font-bold text-text-primary">Üye Düzenle</h1></div>
