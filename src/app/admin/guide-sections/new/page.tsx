...
export default function NewGuideSectionPage() {
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6"><Link href="/admin/guide-sections" className="text-text-secondary hover:text-primary"><ArrowLeft className="w-5 h-5" /></Link><h1 className="text-xl sm:text-2xl font-heading font-bold text-text-primary truncate">Yeni Bölüm</h1></div>
